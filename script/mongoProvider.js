...
MongoProvider.prototype.dataFromMongo = function() {
...
MongoProvider.prototype.transformToJsons = function(array) {
    var i,j,temp;
    var arr = [];
...
MongoProvider.prototype.saveToBlockChain = function (array) {
    var promiseArray = [];
    var that = this;
    for (obj of array) {
...
MongoProvider.prototype.queryAndSave = function () {
  var that = this;
